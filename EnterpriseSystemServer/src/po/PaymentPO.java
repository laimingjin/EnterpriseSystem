...
public class PaymentPO implements Serializable {
	...
	private static final long serialVersionUID = 7539752913743051222L;
	String date;
	String documentID;
	int customerID;
	String customerName;
	...
	boolean isDealed;
	public PaymentPO(String date,String documentID,int customerID,String customerName,int userID,String userName, TransferList transferList,double totalPrice,boolean isPass,boolean isSend,boolean isDealed){
		this.date=date;

...
public class CommodityDetilUI extends SuperInputUI {
//	private static final long serialVersionUID = 1L;
	...
	public CommodityDetilUI(JFrame frame, ImportList myList) {
		super(frame);
		myImportList = myList;
		this.setLayout(null);
	...
	public CommodityDetilUI(JFrame frame, SaleList myList) {
		super(frame);
		mySaleList = myList;
		this.setLayout(null);
		this.setSize(MyDocumentInputFrame.FRAME_WIDTH,

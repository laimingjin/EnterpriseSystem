...
public class AccountCheckInputUI extends SuperInputUI {
...
//	private static final long serialVersionUID = 1L;
	...
	public AccountCheckInputUI(AccountCheckUI myUI,JFrame frame) {
		super(frame);
		accountCheckUI=myUI;
		initialize();
		setLayout(null);
	...
	class ButtonListener implements ActionListener{
      AccountCheckInputUI currentPanel;
      public ButtonListener(AccountCheckInputUI panel){
    	  currentPanel=panel;
      }
		public void actionPerformed(ActionEvent e) {
			...
			arr.add(salesListVO);
			if(arr.size()!=0){
				accountCheckUI.showSaleListSearchInfo(arr);
	...
	//监听
		class outPutButtonListener implements ActionListener{
	      AccountCheckInputUI currentPanel;
	      public outPutButtonListener(AccountCheckInputUI panel){
	    	  currentPanel=panel;
	      }
			public void actionPerformed(ActionEvent e) {

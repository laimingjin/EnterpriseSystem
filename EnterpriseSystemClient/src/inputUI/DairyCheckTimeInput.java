...
public class DairyCheckTimeInput extends SuperInputUI{
...
//	private static final long serialVersionUID = 1L;
	public  DairyCheckTimeInput  (DairyCheckUI myPanel,JFrame frame) {
		super(frame);
	...
	class ButtonListener implements ActionListener {
		private DairyCheckTimeInput currentPanel;
        public ButtonListener(DairyCheckTimeInput panel){
        	currentPanel=panel;
        }
		public void actionPerformed(ActionEvent e) {
			...
			ArrayList<LogVO>logVOs=logBLService.findByTime(y1.substring(0,4 )+m1.substring(0,2)+d1.substring(0,2)+","+y2.substring(0,4)+m2.substring(0,2)+d2.substring(0,2));
if(logVOs.size()!=0){

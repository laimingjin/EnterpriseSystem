...
public class MyInputFrame extends JFrame{
//private static final long serialVersionUID = 1L;
	
	//private static MyInputFrame MY_INPUTFRAME = new MyInputFrame();
	public final static int FRAME_WIDTH = 446;// 固定窗口的宽
	public final static int FRAME_HEIGHT = 513;// 固定窗口的高
	// 用于检测显示器的大小
...
//	public MyInputFrame(JPanel currentpanel) {// 构造器

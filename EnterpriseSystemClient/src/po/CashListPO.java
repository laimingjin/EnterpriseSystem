...
EntryList entryList;
	...
	public CashListPO(CashListVO cashListVO) {
		this.date=cashListVO.getDate();
		this.documentID=cashListVO.getDocumentID();
		this.userID=cashListVO.getUserID();
		this.userName=cashListVO.getUserName();
		this.accountName=cashListVO.getAccountName();
	this.entryList=cashListVO.getEntryList();
		this.totalPrice=cashListVO.getTotalPrice();
		this.isPass=cashListVO.isPass();
		this.isSend=cashListVO.isSend();
		this.isDealed=cashListVO.isDealed();
	}

...
/**
 * @author 小春 2014年12月9日下午9:32:35 EnterpriseSystem InputUI SaleComChooseUI.java
 */
public class SaleComChooseUI extends JPanel {
	...
	public SaleInputUI callBackPanel;
	...
	public SaleComChooseUI(SaleInputUI panel, Frame frame) {
		callBackPanel = panel;
		currentFrame = frame;
	...
	class tree_selection_listener implements TreeSelectionListener {
		SaleComChooseUI callBackPanel;

		public tree_selection_listener(SaleComChooseUI panel) {
			callBackPanel = panel;
		}

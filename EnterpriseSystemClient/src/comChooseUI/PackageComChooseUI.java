...
public class PackageComChooseUI extends JPanel{
	...
	public SpecialPriceInputUI callBackPanel;
	...
	public PackageComChooseUI(SpecialPriceInputUI panel, Frame frame) {
		callBackPanel = panel;
		currentFrame = frame;
	...
	private JTree getCommodityTree() {
		...
		if (commodityTree == null) {
			...
			commodityTree.addTreeSelectionListener(new tree_selection_listener(this));
		}
		return commodityTree;
	}

	class tree_selection_listener implements TreeSelectionListener {
		PackageComChooseUI currentPanel;

		public tree_selection_listener(PackageComChooseUI panel) {
			currentPanel = panel;
		}

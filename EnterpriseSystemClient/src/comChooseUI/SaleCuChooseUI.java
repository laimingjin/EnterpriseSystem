...
public class SaleCuChooseUI extends SuperInputUI{
	...
	public SaleCuChooseUI(SaleUI panel, JFrame frame) {
		super(frame);
		callBackPanel = panel;
		getInit();
		getButtonInit();
	...
	class ButtonListener implements ActionListener {
		int buttonID;
		SaleCuChooseUI currentPanel;
		public ButtonListener(int id,SaleCuChooseUI panel) {
			buttonID = id;
			currentPanel=panel;
		}

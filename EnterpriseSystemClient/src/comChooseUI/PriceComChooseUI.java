...
public class PriceComChooseUI extends JPanel {
...
//	private static final long serialVersionUID = 1L;
	...
	public PromotionPriceInputUI callBackPanel;
	...
	public PriceComChooseUI(PromotionPriceInputUI panel, Frame frame) {
		callBackPanel = panel;
		currentFrame = frame;
	...
	class tree_selection_listener implements TreeSelectionListener {
		PriceComChooseUI currentPanel;

		public tree_selection_listener(PriceComChooseUI panel) {
			currentPanel = panel;
		}
